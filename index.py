...
js.document.body.prepend(js.MathJax.mathml2chtml(['<math>', sympy.mathml(ground.subs(length, sympy.solveset(ground.diff(length), length).sup), printer='presentation'), '</math>'].join('')))
