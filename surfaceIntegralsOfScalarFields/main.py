...
#assert base.mv() == sympy.Matrix(cartesian.mv()).T @ sympy.Matrix(base.u).jacobian(base.coords)
assert base.g == sympy.trigsimp(sympy.Matrix(base.u).jacobian(base.coords).T @ sympy.Matrix(base.u).jacobian(base.coords))
