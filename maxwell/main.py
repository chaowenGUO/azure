...
response += sympy.mathml((base.grad*base.grad*potential).subs(sympy.symbols('t',real=True) * sympy.symbols('c',real=True), sympy.symbols('t',real=True)).obj.doit(), printer='presentation'),
